...
from django.core.management.base import BaseCommand, CommandError  # Add Error
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument(
            ...
            default=10,
            type=int,
            help="[Optional] Number of questions to create",
        )
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.SUCCESS(
                f"Successfully created {amount} dummy questions and choices."
            )
        )
